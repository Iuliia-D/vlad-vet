    ...
    <div>
      ...
      <div className={classes.about}>
        ...
        <div className={classes.about__title}>
          <h2>{t("mainTitle")}</h2>
          <div className={classes.about__descrDesktop}>
            <p>{t("mainDescription.part1")}</p>
            <p>{t("mainDescription.part2")}</p>
          </div>
        </div>
      </div>
      <div className={classes.about__descrMobile}>
        <p>{t("mainDescription.part1")}</p>
        <p>{t("mainDescription.part2")}</p>
      </div>
      <div className={classes.about_detail}>
        ...
        <div className={classes.about_detail__text}>
          <div className={classes.about_detail__textBlock}>
            <h2>{t("aboutTitle")}</h2>
            <ul>
              <li>
